...
public class App extends javax.swing.JFrame {
    ...
    public App() {
        ...
        buttons = new Button[]{
            ...
            new Button(jButtonCloseBrack, "closeBrack", 4, ")", 0),
            new Button(jButtonEuler, "euler", 1, "e^", 10),
            new Button(jButtonSqrt, "sqrt", 1, "√", 10),
            new Button(jButton2, "one", 0, "2", 0),
            new Button(jButton7, "seven", 0, "7", 0),
            new Button(jButtonPI, "pi", 3, "π", 0),
            new Button(jButtonFact, "fact", 1, "!", 10),
            new Button(jButtonDecPoint, "point", 6, ".", 0),
            new Button(jButton9, "nine", 0, "9", 0),
            new Button(jButtonClrAll, "clearAll", 4, "", 0),
            new Button(jButtonInv, "inverse", 1, "1/", 10),
            new Button(jButtonInvLog10, "antiLog", 1, "10^", 10),
            new Button(jButtonSqr, "sqr", 1, "²", 10),
            new Button(jButtonMult, "times", 2, " * ", 8),
            new Button(jButtonPM, "pm", 5, "", 0),
            new Button(jButtonOpenBrack, "openBrack", 4, "(", 11),
            new Button(jButton3, "three", 0, "3", 0),
            new Button(jButtonCos, "cosine", 1, "cos ", 10),
            new Button(jButtonTan, "tangent", 1, "tan ", 10),
            new Button(jButtonMinus, "minus", 2, " - ", 5),
            new Button(jButtonExp, "exp", 2, " ^ ", 9),
            new Button(jButton8, "eight", 0, "8", 0),
            new Button(jButtonArcSin, "arcSine", 1, "sin⁻¹ ", 10),
            new Button(jButtonLog10, "log", 1, "log ", 10),
            new Button(jButtonClrInput, "clearInput", 4, "", 0),
            new Button(jButtonDel, "delete", 4, "", 0),
            new Button(jButtonLog, "nLog", 1, "ln ", 10),
            new Button(jButton5, "five", 0, "5", 0),
            new Button(jButton0, "zero", 0, "0", 0),
            new Button(jButtonPlus, "plus", 2, " + ", 5),
            new Button(jButton4, "four", 0, "4", 0),
            new Button(jButtonRoot, "root", 2, "√", 10),
            new Button(jButtonArcCos, "arcCosine", 1, "cos⁻¹ ", 10),
            new Button(jButtonArcTan, "arcTangent", 1, "tan⁻¹ ", 10),
            new Button(jButtonEqual, "equal", 4, " =", 0),
            new Button(jButtonSin, "sine", 1, "sin ", 10)};
    }
